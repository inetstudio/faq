...
class ServiceProvider extends BaseServiceProvider
{
    ...
    protected function registerPublishes(): void
    {
        ...
        $this->publishes(
            [
                __DIR__.'/../../database/migrations/create_faq_tags_tables.php.stub' => database_path(
                    'migrations/'.$timestamp.'_create_faq_tags_tables.php'
                ),
            ],
            'migrations'
        );
    ...
    protected function registerFormComponents(): void
    {
        FormBuilder::component(
            'faq_tags',
            'admin.module.faq.tags::back.forms.fields.tags',
